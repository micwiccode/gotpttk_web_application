...
final class Version20200109180645 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trail (idT INT AUTO_INCREMENT NOT NULL, sumOfPointsGOT INT NOT NULL, trailLength DOUBLE PRECISION NOT NULL, hasSectionsOutOfBase TINYINT(1) NOT NULL, is_verified TINYINT(1) NOT NULL, trailDate DATE DEFAULT NULL, idBook INT NOT NULL, INDEX IDX_2C42079B818FDAF (idBook), PRIMARY KEY(idT)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE section_trail (section_date DATE DEFAULT NULL, idT INT NOT NULL, idS INT NOT NULL, INDEX IDX_9593471D3CB3B7C6 (idT), INDEX IDX_9593471D4BB48750 (idS), PRIMARY KEY(idT, idS)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE trail ADD CONSTRAINT FK_2C42079B818FDAF FOREIGN KEY (idBook) REFERENCES book (idB)');
        ...
        $this->addSql('ALTER TABLE section_trail ADD CONSTRAINT FK_9593471D3CB3B7C6 FOREIGN KEY (idT) REFERENCES trail (idT)');
        $this->addSql('ALTER TABLE section_trail ADD CONSTRAINT FK_9593471D4BB48750 FOREIGN KEY (idS) REFERENCES section (idS)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trail DROP FOREIGN KEY FK_2C42079B818FDAF');
        ...
        $this->addSql('ALTER TABLE section_trail DROP FOREIGN KEY FK_9593471D3CB3B7C6');
        $this->addSql('ALTER TABLE section_trail DROP FOREIGN KEY FK_9593471D4BB48750');
